...
class MonthsTokenParserTest {

    @InjectMocks
    private MonthsTokenParser underTest;
    ...
    public void should_parse_valid_star_command() {
        ...
        assertEquals(12, result.getRangeEnd());
    ...
    public void should_parse_and_fail_out_of_range_lower() {
        Exception exception = assertThrows(ParserException.class,
                () -> underTest.parse("0"));
        assertEquals(
                "Number '0' should be in range '1' and '12'.",
                exception.getMessage());
    }
    ...
    public void should_parse_and_fail_out_of_range_higher() {
        Exception exception = assertThrows(ParserException.class,
                () -> underTest.parse("32"));
        assertEquals(
                "Number '32' should be in range '1' and '12'.",
                exception.getMessage());
    }
